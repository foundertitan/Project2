...
import com.arati_giri.project2.Domain.ReviewDomain;
import com.arati_giri.project2.databinding.ViewholderReviewBinding;
...
public class ReviewAdapter extends RecyclerView.Adapter<ReviewAdapter.Viewholder> {
    ...
    public void onBindViewHolder(@NonNull ReviewAdapter.Viewholder holder, int position) {
        ...
        Glide.with(context)
                ...
                .transform(new GranularRoundedCorners(100,100,100,10))
